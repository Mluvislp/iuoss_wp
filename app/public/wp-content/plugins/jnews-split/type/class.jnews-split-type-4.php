...
class JNews_Split_Type_4 extends JNews_Split_Type_Abstract {
			...
			' <div class="jeg_splitpost_bar jeg_splitpost_4">
                ...
                <div class=\"pagenav_wrap\">
                    <div class=\"page_nav prev {$previous_class}\">
                        <a href=\"{$previous_url}\" aria-label=\"Show previous page posts\"><span>" . jnews_return_translation( 'Previous', 'jnews-split', 'previous' ) . "</span></a>
                    </div>
                    <div class=\"page_nav next {$next_class}\">
                        <a href=\"{$next_url}\" aria-label=\"Show next page posts\"><span>" . jnews_return_translation( 'Next', 'jnews-split', 'next' ) . '</span></a>
                    </div>
                </div>
            </div>';
	...
	public function bottom_nav() {
		...
		$previous =
			"<div class=\"page_nav prev {$previous_class}\">
                <a href=\"{$previous_url}\" data-id=\"{$previous_index}\" aria-label=\"Show previous page posts\">
		...
		$next =
			"<div class=\"page_nav next {$next_class}\">
                <a href=\"{$next_url}\" data-id=\"{$next_index}\" aria-label=\"Show next page posts\">
