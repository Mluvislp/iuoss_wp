		...
		$output =
			'<div class="jeg_splitpost_bar jeg_splitpost_5">
                    ...
                    <div class=\"pagenav_wrap\">
                        <div class=\"page_nav prev {$previous_class}\"><a href=\"{$previous_url}\" aria-label=\"Show previous page posts\"><i class=\"fa {$prev_icon}\"></i></div>
                        <div class=\"page_nav next {$next_class}\"><a href=\"{$next_url}\" aria-label=\"Show next page posts\"><i class=\"fa {$next_icon}\"></i></a></div>
                    </div>
                </div>";
