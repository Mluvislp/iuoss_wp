...
class VP_Option {
	...
	public function __construct( array $configs ) {
		...
		// setup ajax
		add_action(
			'wp_ajax_vp_ajax_' . $this->get_option_key() . '_export_option',
			array(
				$this,
				'ajax_export_option',
			)
		...
		add_action(
			'wp_ajax_vp_ajax_' . $this->get_option_key() . '_import_option',
			array(
				$this,
				'ajax_import_option',
			)
	...
	/**
	 * Overrdie the _option_key value
	 * Needed when translateting string in multilang
	 *
	 * @param String $key option key.
	 */
	public function override_option_key( $key ) {
		//see rmzeoutl
		$this->_option_key = $key;
		return $this;
	}
