...
class Customizer {
	 ...
	 *
	 * @param bool $load_google Load google fonts or not.
	 *
	 * @return mixed
	 */
	public function load_all_font( $load_google = true ) {
		...
		return apply_filters( 'jeg_font_typography', $standard_fonts_final );
	}
	...
	public function previewer_script() {
		...
		$in_footer = 1;
		$wp_scripts->add( $handle, $src, $deps, false, $in_footer );
		...
		wp_localize_script(
			...
			array(
				...
				'allFont'         => $this->load_all_font( false ),
			)
		);
