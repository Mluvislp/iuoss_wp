...
class JNews_Meta_Twitter extends JNews_Meta_Abstract {
	...
	public function get_post_title() {
		$title = jnews_get_metabox_value( 'jnews_social_meta.twitter_title', null, $this->post_id );
	...
	public function get_post_description() {
		$description = jnews_get_metabox_value( 'jnews_social_meta.twitter_description', null, $this->post_id );
	...
	public function get_post_image() {
		$attachment_id = jnews_get_metabox_value( 'jnews_social_meta.twitter_image', null, $this->post_id );
	...
	public function render_post_meta() {
		...
		if ( $image ) {
			$narrow_space = "\xE2\x80\xAF";
			if ( strpos( $image[0], $narrow_space ) !== false ) {
				$image[0] = str_replace( $narrow_space, '%E2%80%AF', $image[0] );/* see Dpr85Dvh */
			}
			$meta[] = array(
