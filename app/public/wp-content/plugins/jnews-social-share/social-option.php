...
$share_network = array(
	...
	'xing'          => esc_attr__( 'Xing', 'jnews-social-share' ),
	'threads'       => esc_attr__( 'Threads', 'jnews-social-share' ),
	'bluesky'       => esc_attr__( 'Bluesky', 'jnews-social-share' ),
);
...
/* see LZezGfXs */
$options[] = array(
	'id'          => 'jnews_option[single_social_share_enable_api]',
	'option_type' => 'option',
	'transport'   => 'postMessage',
	'default'     => array( 'facebook', 'pinterest', 'vk' ),
	'type'        => 'jnews-select',
	'label'       => esc_html__( 'Social Share Counter API', 'jnews-social-share' ),
	'description' => esc_html__( 'Select the social media platforms which you want to retrieve share count values via API.', 'jnews-social-share' ),
	'multiple'    => 5,
	'choices'     => array(
		'facebook'  => esc_attr__( 'Facebook', 'jnews-social-share' ),
		'pinterest' => esc_attr__( 'Pinterest', 'jnews-social-share' ),
