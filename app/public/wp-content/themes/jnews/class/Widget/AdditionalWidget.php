...
class AdditionalWidget {
	...
	/**
	 * Merge widget options with additional JNews widget form.
	 *
	 * @param array $instance Widget options.
	 * @param array $new_instance New value from widget form before it processed.
	 * @return array
	 */
	public function update_widget_form( $instance, $new_instance ) {
		$keys = array(
			'second_title',
			'header_url',
			'header_type',
		...
		return array_merge( $instance, array_intersect_key( $new_instance, array_flip( $keys ) ) ); /* see c6Rl3VA6 */
	}
