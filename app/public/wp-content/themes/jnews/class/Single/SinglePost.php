...
Class SinglePost {
	...
	public function related_post( $echo = true ) {
		if ( $this->can_render_related_post() ) {
			...
			$attr = array(
				'first_title'             => get_theme_mod( 'jnews_single_post_related_override_title', false ) ? jnews_get_translated_setting( get_theme_mod( 'jnews_single_post_related_ftitle', 'Related' ) ) : jnews_return_translation( 'Related', 'jnews', 'related' ),
				'second_title'            => get_theme_mod( 'jnews_single_post_related_override_title', false ) ? jnews_get_translated_setting( get_theme_mod( 'jnews_single_post_related_stitle', 'Posts' ) ) : jnews_return_translation( ' Posts', 'jnews', 'posts' ),
	...
	public function build_inline_related_post() {
		...
		$attr = array(
			'first_title'            => jnews_get_translated_setting( get_theme_mod( 'jnews_single_post_inline_related_ftitle', 'Related' ) ),
			'second_title'           => jnews_get_translated_setting( get_theme_mod( 'jnews_single_post_inline_related_stitle', 'Posts' ) ),
