...
class FrontendAsset extends AssetAbstract {
	...
	public function load_style() {
		...
		if ( ! $this->is_login_page() ) {
			...
			if ( '6' === get_theme_mod( 'jnews_font_awesome_version', '4' ) ) {
				wp_enqueue_style( 'font-awesome-6', $asset_url . 'fonts/font-awesome/v6/all.min.css', null, $theme_version );
				wp_enqueue_style( 'font-awesome-v4-shims', $asset_url . 'fonts/font-awesome/v6/v4-shims.min.css', null, $theme_version );
			} else {
			...
			if ( $this->is_debugging ) {
				...
				if ( $this->font_preloading_enabled ) {
					...
					if ( function_exists( 'vc_asset_url' ) && get_theme_mod( 'jnews_enable_font_preloading_vc', false ) ) {
						wp_enqueue_style( 'vc-font-awesome-brands-webfont', vc_asset_url( 'lib/vendor/node_modules/@fortawesome/fontawesome-free/webfonts/fa-brands-400.woff2' ), null, null );
						wp_enqueue_style( 'vc-font-awesome-regular-webfont', vc_asset_url( 'lib/vendor/node_modules/@fortawesome/fontawesome-free/webfonts/fa-regular-400.woff2' ), null, null );
						wp_enqueue_style( 'vc-font-awesome-solid-webfont', vc_asset_url( 'lib/vendor/node_modules/@fortawesome/fontawesome-free/webfonts/fa-solid-900.woff2' ), null, null );
					}
	...
	public function localize_script() {
		...
		$option['custom_login']   = get_theme_mod( 'jnews_use_custom_login', false ) ? get_theme_mod( 'jnews_custom_login_url', '' ) : ''; /* see Z4SbbUDU */
